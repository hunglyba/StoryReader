...
-(id)init
{
    ...
    if (self) {
        ...
        self.realFont = [UIFont systemFontOfSize:12];
    }
    return self;
}
...
-(NSAttributedString*)attrStringFromMarkup:(NSString*)markup
{
    ...
    NSDictionary* attrs = [NSDictionary dictionaryWithObjectsAndKeys:
                                   ...
                                   self.realFont, kCTFontAttributeName,
                                   ...
                                   nil];
    NSAttributedString *attributeStr = [[NSAttributedString alloc] initWithString:markup attributes:attrs];
...
//    
//    // Build the attributed string from the text and tags.
//    
